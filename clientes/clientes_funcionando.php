...
<form method="post">
    ...
    <input type="text" name="NomeCompletoCliente" required
           value="<?= htmlspecialchars($clienteEdit['NomeCompletoCliente'] ?? '') ?>">

    <label>Documento:</label>
    <input type="text" name="DocumentoCliente"
...
<table border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($c['DocumentoCliente']) ?></td>
            <td><?= $c['Status'] ?></td>
            <td class="acoes">
